...
| J | J1 corpus/CI implemented; J2–J6 pending | All 11 stable fuzz targets now have seed corpora and a smoke/nightly workflow. The deterministic simulator, 22-case adversarial suite, soak/bench/coverage gates, and SBOM job remain to be added. |
